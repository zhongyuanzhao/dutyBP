...
output_csv = os.path.join(output_dir, "test_{}_T_{}_ir_{:.1f}_opts_{}_link-{}_mixed_raw_mlp.csv".format(
...
# load models
actor_model = os.path.join(modeldir, 'model_MLP_{}_a{}_actor'.format(FLAGS.training_set, 5, 5))
