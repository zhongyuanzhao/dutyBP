...
for gtype in 'poisson'; do
    ...
    for radius in 1.0; do
        for opts in '0' '60,50' '7,27' '57,67' '5,25' '6,26' '9,29' '39,49' '4,44' '35,45' ; do
            ...
            python3 bp_test_sch_load.py --training_set=PPm8 --datapath=${datapath} --opts=${opts} --out=../out --learning_rate=0.0001 --weight_decay=0.01 --radius=${radius} --gtype=${gtype} --T=${T} &
